...
class BarangkeluarController extends Controller
{
    ...
    public function proses_tambah(Request $request)
    {
        ...
        //insert data
        $modelBarang = BarangModel::firstWhere('barang_kode',$request->barang);
        if ($modelBarang->barang_stok < $request->jml) {
            return response()->json(['error'=>'Jumlah Barang Keluar Tidak Boleh Lebih Besar Dari Stok Barang'],400);
        }
